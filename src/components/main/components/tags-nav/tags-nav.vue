<template>
  <div class="tags-nav">
    <div class="close-con">
      <Dropdown transfer @on-click="handleTagsOption" style="margin-top:15px;">
        <div type="text">
          <Icon style="margin-top: -11px;" :size="18" type="ios-close-circle-outline" />
        </div>
        <DropdownMenu slot="list" v-waves>
